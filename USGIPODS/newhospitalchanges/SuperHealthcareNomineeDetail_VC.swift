//
//  SuperHealthcareNomineeDetail_VC.swift
//  UniversalSompo
//
...
class SuperHealthcareNomineeDetail_VC: BaseViewController,UITextFieldDelegate {
    ...
    @IBAction func continueAction(_ sender:UIButton){
        self.validation()
        let nextVc = UIStoryboard.init(name: "Health", bundle: nil).instantiateViewController(withIdentifier: "SuperHealthPyment_Vc") as! SuperHealthPyment_Vc
