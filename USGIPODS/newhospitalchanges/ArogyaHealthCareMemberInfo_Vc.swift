//
//  ArogyaHealthCareMemberInfo_Vc.swift
//  UniversalSompo
//
//  Created by Subesh on 06/10/1400 AP.
...
class ArogyaHealthCareMemberInfo_Vc: BaseViewController,UITextFieldDelegate  {
    ...
    @IBOutlet var installment_Txt: UITextField!
    ...
    @IBOutlet weak var firstAdultDoubleeNs : NSLayoutConstraint!
    @IBOutlet weak var secondAdultDoubleeNs: NSLayoutConstraint!
    @IBOutlet weak var firstChildDoubleeNs : NSLayoutConstraint!
    @IBOutlet weak var secondChildDoubleeNs: NSLayoutConstraint!
    @IBOutlet weak var thirdChildDoubleeNs : NSLayoutConstraint!
    @IBOutlet weak var fourthChildDoubleeNs: NSLayoutConstraint!
    ...
    var asiQouteInsuredInfo = [[String:Any]](); var fArrayAdult = [String:Any](); var sArryAdult = [String:Any](); var fArrayChild = [String:Any](); var sArrayChild = [String:Any](); var tArrayChild = [String:Any](); var frArrayChild = [String:Any](); var single = [String:Any](); var InstallmentFrequency = String()
    var totalAmount  = String(); var netPremiumm = String();var gstValue = String(); var installment = String()
    var firstAdultDob = String();  var secondAdultDob = String()
    ...
    func cornerRadious(){
        ...
        self.installment_Txt.layer .cornerRadius = 20
        ...
        self.firstAdultDoubleeNs.constant = 10
        self.secondAdultDoubleeNs.constant = 0
        self.firstChildDoubleeNs.constant = 0
        self.secondChildDoubleeNs.constant = 0
        self.thirdChildDoubleeNs.constant = 0
        self.fourthChildDoubleeNs.constant = 0
    ...
    func borderwidth(){
        ...
        self.installment_Txt.layer.borderWidth = 0.5
    ...
    //MARK: - family type button action
       func familyFloater(){
              if family == "1 Adult"{
                  ...
                  self.firstAdultDoubleeNs.constant = 0
                  self.secondAdultDoubleeNs.constant = 0
                  self.firstChildDoubleeNs.constant = 0
                  self.secondChildDoubleeNs.constant = 0
                  self.thirdChildDoubleeNs.constant = 0
                  self.fourthChildDoubleeNs.constant = 0
                  self.fArrayAdult = ["Name":  "yogesh",     //String( ProjectUtils.getUserName()),
                                      "DOB":self.firstAdultDob,
                                 "Gender":"Male",
                                 "HeightInFeet":"6",
                                 "HeightInInches":"7",
                                 "Weight":"68","BMI":"22.12",
                  ...
                  self.asiQouteInsuredInfo.append(self.fArrayAdult)

            }else if family == "2 Adult"{
                self.adjustable_View.frame.size.height = 1750
                //self.firstAdultView.isHidden = false
               ...
               self.firstChildAdNsView.constant = 0
                ...
                self.firstAdultDoubleeNs .constant = 10
                self.secondAdultDoubleeNs.constant = 10
                self.firstChildDoubleeNs .constant = 0
                self.secondChildDoubleeNs.constant = 0
                self.thirdChildDoubleeNs .constant = 0
                self.fourthChildDoubleeNs.constant = 0
                ...
                self.fArrayAdult = ["Name": "yogesh",        //String( ProjectUtils.getUserName()),
                               ...
                               "Relation":"Self",
                               "SumInsured":self.suminsured ]
                self.sArryAdult = ["Name": "yogesh",           //String(ProjectUtils.getUserName()),
                               "DOB":"27/01/1995",
                               "Gender":"Male",
                               "HeightInFeet":"6",
                               "HeightInInches":"7",
                               ...
                               "SumInsured":self.suminsured ]
                self.asiQouteInsuredInfo.append(self.fArrayAdult)
                self.asiQouteInsuredInfo.append(self.sArryAdult)
                
            }else  if family == "1 Adult + 1 Child"{
                self.adjustable_View.frame.size.height = 1750  //2000
               // self.firstAdultView.isHidden = false
               ...
               // self.firstChildAdNsView.constant = 550
                ...
                self.fourthChildAdNsView.constant = 10
                self.firstAdultDoubleeNs .constant = 0
                self.secondAdultDoubleeNs.constant = 10
                self.firstChildDoubleeNs .constant = 0
                self.secondChildDoubleeNs.constant = 0
                ...
                self.adjustable_View.frame.size.height = 2300  // 2400
                //self.firstAdultView.isHidden = false
                //self.firstAdNsView.constant = 0
                self.spousesAdultView.isHidden = true
                self.spousesAdNsView.constant = 0
               ...
               //self.secondChildsAdNsView.constant = 0
                ...
                self.firstAdultDoubleeNs .constant = 10
                self.secondAdultDoubleeNs.constant = 0
                self.firstChildDoubleeNs .constant = 10
                self.secondChildDoubleeNs.constant = 10
                self.thirdChildDoubleeNs .constant = 0
                self.fourthChildDoubleeNs.constant = 0
            }else if family == "1 Adult + 3 Child" {
                self.adjustable_View.frame.size.height = 2800 ///2800
//                self.firstAdultView.isHidden = false
//                self.firstAdNsView.constant = 0
                self.spousesAdultView.isHidden = true
                self.spousesAdNsView.constant = 0
...
//                self.thirdChildAdNsView.constant = 0
                ...
                self.firstChildDoubleeNs .constant = 10
                self.secondChildDoubleeNs.constant = 10
                self.thirdChildDoubleeNs .constant = 10
                self.fourthChildDoubleeNs.constant = 0
            }else if family == "2 Adult + 1 Child"{
                self.adjustable_View.frame.size.height = 2400   //2500
                //self.firstAdultView.isHidden = false
                //self.firstAdNsView.constant = 0
                //self.spousesAdultView.isHidden = false
                //self.spousesAdNsView.constant = 0
                ...
                self.adjustable_View.frame.size.height = 2800   //2850
               //self.firstAdultView.isHidden = false
               //self.firstAdNsView.constant = 0
               //self.spousesAdultView.isHidden = false
               //self.spousesAdNsView.constant = 0
               ...
               //self.thirdChildAdNsView.constant = 0
                ...
                self.secondChildDoubleeNs.constant = 10
                self.thirdChildDoubleeNs .constant = 10
                self.fourthChildDoubleeNs.constant = 10
            }
          }
    ...
    @IBAction func firstAdultOccupationAction(_ sender: Any) {
        ...
        dropDown.anchorView = (sender as! AnchorView)
        dropDown.direction = .bottom
          dropDown.dataSource = ["Select Occupation","Doctor","Accounts","Students","Bankers","Lawyer","Architects","Counting Enginners","Teachers","Housewifes","Self Employed","Salaried"]
          dropDown.selectionAction = { [unowned self] (index: Int, item: String) in
...
//
    ...
    @IBAction func continueAction(_ sender: Any) {
        self.validation()
        self.retrieveData()
        let nextVc = UIStoryboard.init(name: "Health", bundle:  nil).instantiateViewController(withIdentifier: "ArogyaSanjeevaniMedicalRetrieve_VC") as! ArogyaSanjeevaniMedicalRetrieve_VC
        self.navigationController?.pushViewController(nextVc, animated: true)
         }
         }
//MARK: - extension for the policyquat Api
extension ArogyaHealthCareMemberInfo_Vc {
    private func superHealthPolicyQuat() {
//            self.asiQouteInsuredInfo = [["Name":String( ProjectUtils.getUserName()),
//                                             "DOB":"27/01/1995",
//                                             "Gender":"Male",
//                                             "HeightInFeet":"6",
//                                             "HeightInInches":"7",
            ...
            if ((JSONResponse.dictionaryObject) != nil) {
                DispatchQueue.main.async {
                    ...
                    if  let NetPremium = response["NetPremium"] {
                        ...
                        if  let totalpremium = response["TotalPremium"] {
                        self.totalAmountTxt.text =   "\(totalpremium)"
                        self.totalAmount =  "\(totalpremium)"
                    }
                    //self.totalAmount
