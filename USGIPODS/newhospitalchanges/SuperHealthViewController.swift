//
//  SuperHealthViewController.swift
//  UniversalSompo
//
...
class SuperHealthViewController: BaseViewController {
    ...
    @IBAction func dropdownbtn(_ sender: UIButton) {
        ...
        dropDown.dataSource = ["Select age","18yrs-35yrs","36yrs-35yrs","46yrs-50yrs","51yrs-55yrs","56yrs-60yrs","61yrs-65yrs"]
    ...
    @IBAction func getquoteBtnClicked(_ sender: UIButton){
        if age_Btn.title(for: .normal) == "Select Age" {
            ...
            alert(message: "please select terms and conditions",title: "Message")
                ...
                let nextVc = UIStoryboard.init(name: "Health", bundle: nil).instantiateViewController(withIdentifier: "SuperHealthCareQuote_Vc") as! SuperHealthCareQuote_Vc
