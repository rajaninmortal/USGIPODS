//
//  ArogyaSanjeevaniNomineeDetail_Vc.swift
//  UniversalSompo
//
...
class ArogyaSanjeevaniNomineeDetail_Vc: BaseViewController,UITextFieldDelegate {
    ...
    @IBOutlet weak var monthlyFrequency_Txt: UITextField!
    ...
    func retrieveData(){
        ...
        self.suminsure_Txt.text  = UserDefaults.standard.string(forKey: "suminsured") //Bool
        ...
        self.monthlyFrequency_Txt.text =  UserDefaults.standard.string(forKey: "InstallmentFrequency")
         }
    ...
    //MARK: - func for the cornerRadious
     func cornderRadious(){
        ...
        self.totalLbl.layer.cornerRadius = 20
         ...
         self.monthlyFrequency_Txt.layer
             .cornerRadius = 20
         self.monthlyFrequency_Txt.setLeftPaddingPoints(15)
...
//MARK: - textfield desable
         self.monthlyFrequency_Txt.isUserInteractionEnabled = false
         self.policytenure_Txt.isUserInteractionEnabled = false
         self.suminsure_Txt.isUserInteractionEnabled = false
    ...
    @objc func donePressed() {
        ...
        self.dob_Txt.text = "\(datePicker.date.dateInYyyyMmDd())"
       }
